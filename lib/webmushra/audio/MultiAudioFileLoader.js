...
function MultiAudioFileLoader(_audioContext, _errorHandler) {
...
MultiAudioFileLoader.prototype.addFile = function(_url, _callback, _callbackArgument, _sampleRate) {
    this.files[this.files.length] = {url: _url, callback: _callback, callbackArgument: _callbackArgument, sampleRate: _sampleRate};
};



MultiAudioFileLoader.prototype.startLoading = function(_callbackSuccess) {
    ...
    for (var i = 0; i < this.files.length; ++i) {
      ...
      req.onload = (function() { 
        this.loader.audioContext[this.loader.files[this.index].sampleRate].decodeAudioData(this.request.response, (function(buffer) {
